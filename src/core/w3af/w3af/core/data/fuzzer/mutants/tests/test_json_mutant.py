...
class TestJSONMutant(unittest.TestCase):
    ...
    def test_create_mutants_9116(self):
        ...
        expected_dcs = [
            '{"transaction_amount": 100, "external_reference": "1234", "random_anti_anti_double_click": 11577513359, "token": "16faba8617708", "reason": "www", "installments": 1, "payment_method_id": "visa", "extra_charge": null}',
