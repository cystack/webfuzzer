...
(function (T, aa, p) {
    ...
    function m(b, a, c) {
        var d;
        if (b)if (M(b))for (d in b)d != "prototype" && d != "length" && d != "name" && b.hasOwnProperty(d) && a.call(c, b[d], d); else if (b.forEach && b.forEach !== m)b.forEach(a, c); else if (J(b) && va(b.length))for (d = 0; d < b.length; d++)a.call(c, b[d], d); else for (d in b)b.hasOwnProperty(d) && a.call(c, b[d], d);
        return b
    }
    ...
    function fc(b, a) {
        var c = 0, d;
        if (K(b) || G(b))return b.length; else if (J(b))for (d in b)(!a || b.hasOwnProperty(d)) && c++;
        return c
    }
    ...
    function fa(b, a) {
        ...
        if (c == typeof a &&
        ...
        } else if (ma(b))return ma(a) && b.getTime() == a.getTime(); else {
            ...
            for (d in a)if (!c[d] && d.charAt(0) !== "$" && !M(a[d]))return !1;
            return !0
        }
        return !1
    }
    ...
    function hc(b, a) {
        var c = a;
        /^\$+/.test(b) ? c = p : na(a) ? c = "$WINDOW" : a && aa === a ? c = "$DOCUMENT" : a && a.$evalAsync && a.$watch && (c = "$SCOPE");
        return c
    }
    ...
    function ca(b, a, c) {
        var d = b[Aa], d = Ba[d || -1];
        if (s(c))d || (b[Aa] = d = ++nc, d = Ba[d] = {}), d[a] = c; else return d && d[a]
    }

    function ub(b, a, c) {
        var d = ca(b, "data"), e = s(c), g = !e && s(a), h = g && !J(a);
        !d && !h && ca(b, "data", d = {});
        if (e)d[a] = c; else if (g)if (h)return d && d[a]; else D(d, a); else return d
    }
    ...
    function bb(b, a) {
        if (a)for (var a = !a.nodeName && s(a.length) && !na(a) ? a : [a], c = 0; c < a.length; c++)b.push(a[c])
    }
    ...
    function oc(b, a) {
        var c = function (c, e) {
            ...
            if (!c.target)c.target = c.srcElement || aa;
    ...
    function pb(b) {
        function a(a) {
            return function (b, c) {
                if (J(b))m(b, lb(a)); else return a(b, c)
            }
        }
                ...
                if (!j.get(a))if (j.put(a, !0),
                    ...
                    try {
                        for (var d = c._invokeQueue, c = 0, f = d.length; c < f; c++) {
                            var g = d[c], i = g[0] == "$injector" ? l : l.get(g[0]);
                            i[g[1]].apply(i, g[2])
                        }
                    } catch (h) {
    ...
    function uc(b, a, c, d) {
        ...
        var f = this, i = a[0], j = b.location, k = b.history, l = b.setTimeout, n = b.clearTimeout, r = {};
        f.isMock = !1;
        var o = 0, w = [];
        ...
        var V = {}, I = "", N = f.baseHref();
        f.cookies = function (a, b) {
            var d, e, f, g;
            if (a)if (b === p)i.cookie = escape(a) + "=;path=" + N + ";expires=Thu, 01 Jan 1970 00:00:00 GMT"; else {
        ...
        this.directive = function f(d, e) {
            G(d) ? (pa(e, "directive"), a.hasOwnProperty(d) || (a[d] = [], b.factory(d + c, ["$injector", "$exceptionHandler", function (b, c) {
                ...
                m(a[d], function (a) {
                    try {
                        var f = b.invoke(a);
                        if (M(f))f = {compile: B(f)}; else if (!f.compile && f.link)f.compile = B(f.link);
        ...
        this.$get = ["$injector", "$interpolate", "$exceptionHandler",
            "$http", "$templateCache", "$parse", "$controller", "$rootScope", function (b, i, j, k, l, n, r, o) {
                ...
                function t(a, b, c, d) {
                    ...
                    for (var f = [], g, j, i, n = 0; n < a.length; n++)j = new da, g = X(a[n], [], j, d), j = (g = g.length ? A(g, a[n], j, b, c) : null) && g.terminal ? null : t(a[n].childNodes, g ? g.transclude : b), f.push(g), f.push(j), i = i || g || j;
                    return i ? e : null
                }
                ...
                function X(a, b, c, f) {
                    ...
                    switch (a.nodeType) {
                        case 1:
                            y(b,
                                ea(Cb(a).toLowerCase()), "E", f);
                            var i, n, k;
                            j = a.attributes;
                            for (var l = 0, o = j && j.length; l < o; l++)if (i = j[l], i.specified)n = i.name, k = ea(n.toLowerCase()), g[k] = n, c[k] = i = Q(Z && n == "href" ? decodeURIComponent(a.getAttribute(n, 2)) : i.value), yb(a, k) && (c[k] = !0), W(a, b, i, k), y(b, k, "A", f);
                            a = a.className;
                            if (G(a))for (; j = e.exec(a);)k = ea(j[2]), y(b, k, "C", f) && (c[k] = Q(j[3])), a = a.substr(j.index + j[0].length);
                            break;
                        case 3:
                            F(b, a.nodeValue);
                            break;
                        case 8:
                            try {
                                if (j = d.exec(a.nodeValue))k = ea(j[1]), y(b, k, "M", f) && (c[k] = Q(j[2]))
                            } catch (r) {
                            }
                    }
                    b.sort(I);
                ...
                function A(a, b, c, d, e) {
                    ...
                    function k(a, d, e, f, g) {
                        var l, q, w, L, Ha;
                        l = b === e ? c : gc(c, new da(u(e), c.$attr));
                        q = l.$$element;
                        if (A && J(A.scope)) {
                            var yc = /^\s*([@=&])\s*(\w*)\s*$/,
                                ja = d.$parent || d;
                            m(A.scope, function (a, b) {
                                var c = a.match(yc) || [], e = c[2] || b, f, g, j;
                                switch (c[1]) {
                                    case "@":
                        ...
                        s && m(s, function (a) {
                            var b = {$scope: d, $element: q, $attrs: l, $transclude: g};
                            Ha = a.controller;
                            Ha == "@" && (Ha = l[a.name]);
                    ...
                    for (var l = -Number.MAX_VALUE, o = [], t = [], A = null, y = null, I = null, F = c.$$element = u(b), E, W, $, x, v = d, s, D, B, C = 0, H = a.length; C < H; C++) {
                        ...
                        if (B = E.transclude)N("transclusion", x, E, F), x = E, l = E.priority, B == "element" ? ($ = u(b), F = c.$$element = u("<\!-- " + W + ": " + c[W] + " --\>"), b = F[0], Ga(e, u($[0]), b), v = w($, d, l)) : ($ = u(cb(b)).contents(), F.html(""), v = w($, d));
                        if (B = E.template)if (N("template", I, E, F), I = E, $ = u("<div>" + Q(B) + "</div>").contents(), b = $[0], E.replace) {
                            if ($.length !=
                                1 || b.nodeType !== 1)throw new z(g + B);
                            Ga(e, F, b);
                            W = {$attr: {}};
                            a = a.concat(X(b, a.splice(C + 1, a.length - (C + 1)), W));
                            L(c, W);
                            H = a.length
                        } else F.html(B);
                        if (E.templateUrl)N("template", I, E, F), I = E, k = V(a.splice(C, a.length - C), k, F, c, e, E.replace, v), H = a.length; else if (E.compile)try {
                ...
                function y(d, e, g, i) {
                    var n = !1;
                    if (a.hasOwnProperty(e))for (var k, e = b.get(e +
                ...
                function V(a, b, c, d, e, f, j) {
                    var i =
                        [], n, o, r = c[0], q = a.shift(), w = D({}, q, {
                        controller: null,
                        templateUrl: null,
                        transclude: null
                    });
                    c.html("");
                    k.get(q.templateUrl, {cache: l}).success(function (k) {
                        var l, q;
                        if (f) {
                ...
                function W(a, b, c, d) {
                    var e = i(c, !0);
                    e && b.push({
                        priority: 100, compile: B(function (a, b, c) {
    ...
    function Ac() {
        ...
        this.$get = ["$injector", "$window", function (a, c) {
            return function (d, e) {
                if (G(d)) {
                    var g = d, d = b.hasOwnProperty(g) ? b[g] : eb(e.$scope, g, !0) || eb(c, g, !0);
                    qa(d, g, !0)
                }
        ...
        this.$get = ["$rootScope", "$browser", "$sniffer", "$rootElement", function (c, d, e, g) {
            ...
            g.bind("click", function (a) {
                if (!a.ctrlKey && !(a.metaKey || a.which == 2)) {
                    for (var b = u(a.target); C(b[0].nodeName) !== "a";)if (b[0] === g[0] || !(b = b.parent())[0])return;
    ...
    function Jc(b, a) {
        ...
        function j() {
            for (var a = "", c = o; o < b.length;) {
                ...
                if (j == "." || e(j))a += j; else {
                    var g = d();
                    if (j == "e" && f(g))a += j; else if (f(j) && g && e(g) && a.charAt(a.length - 1) == "e")a += j; else if (f(j) && (!g || !e(g)) && a.charAt(a.length - 1) == "e")i("Invalid exponent"); else break
                }
                o++
            }
            a *= 1;
        ...
        function k() {
            ...
            n.push(d);
            i && (n.push({index: f, text: ".", json: !1}), n.push({
                index: f +
                1, text: i, json: !1
            }))
        }
        ...
        function l(a) {
            ...
            for (var d = "", f = a, e = !1; o < b.length;) {
                var j = b.charAt(o);
                f += j;
                if (e)j == "u" ? (j = b.substring(o + 1, o + 5), j.match(/[\da-f]{4}/i) || i("Invalid unicode escape [\\u" + j + "]"), o += 4, d += String.fromCharCode(parseInt(j, 16))) : (e = Kc[j], d += e ? e : j), e = !1; else if (j == "\\")e = !0; else if (j == a) {
                    o++;
                    n.push({
                        index: c, text: f, string: d, json: !0, fn: function () {
                            return d
                        }
                    });
                    return
        ...
        for (var n = [], r, o = 0, w = [], q, t = ":"; o < b.length;) {
            ...
            }), c("{[") && w.unshift(q), c("}]") && w.shift(), o++; else if (g(q)) {
                o++;
                continue
            } else {
                var m = q + d(), A = Ka[q], y = Ka[m];
                y ? (n.push({index: o, text: m, fn: y}), o += 2) : A ? (n.push({
                    index: o,
                    text: q,
                    fn: A,
                    json: "[,:".indexOf(t) != -1 && c("+-")
    ...
    function Lc(b, a,
        ...
        function l() {
            for (var a = []; ;)if (N.length > 0 && !h("}", ")", ";", "]") && a.push(v()), !f(";"))return a.length == 1 ? a[0] : function (b, c) {
        ...
        function A() {
            var a;
            if (f("("))a = v(), i(")"); else if (f("["))a = y(); else if (f("{"))a = L(); else {
                var b = f();
        ...
        var V = B(0), I, N = Jc(b, d), F = function () {
            var a = r(), c, d;
            ...
            function i() {
                ...
                if (b && i && b.$route === i.$route &&
                    ...
                    if (b) {
                        ...
                        if (!s(d = b.template))if (s(d = b.templateUrl))d =
                            h.get(d, {cache: f}).then(function (a) {
                                return a.data
                            });
        ...
        this.$get = ["$injector", "$exceptionHandler", "$parse", function (a, c, d) {
            ...
            e.prototype = {
                $new: function (a) {
                    ...
                    }, a.prototype = this, a = new a, a.$id = wa());
                    a["this"] = a;
                    a.$$listeners = {};
                    a.$parent = this;
                    a.$$asyncQueue = [];
                    ...
                    do {
                        ...
                        do {
                            ...
                            if (h = t.$$watchers)for (o = h.length; o--;)try {
                                if (a = h[o], (d = a.get(t)) !== (e = a.last) && !(a.eq ? fa(d, e) : typeof d == "number" && typeof e == "number" && isNaN(d) && isNaN(e)))m = !0, a.last = a.eq ? U(d) : d, a.fn(d, e === f ? d : e, t), q < 5 && (A = 4 - q, p[A] || (p[A] = []), y = M(a.exp) ? "fn: " + (a.exp.name || a.exp.toString()) : a.exp, y += "; newVal: " + ba(d) + "; oldVal: " + ba(e), p[A].push(y))
                            } catch (V) {
                                c(V)
                            }
                            if (!(h = t.$$childHead || t !== this && t.$$nextSibling))for (; t !== this && !(h = t.$$nextSibling);)t = t.$parent
                        } while (t = h);
                    ...
                    }, h = [i].concat(ga.call(arguments, 1)), m, p;
                    do {
                        e = f.$$listeners[a] || d;
                        i.currentScope = f;
                        m = 0;
                    ...
                    do if (d = e, f.currentScope = d, m(d.$$listeners[a], function (a) {
                            try {
                                a.apply(null, g)
                            } catch (b) {
                                c(b)
                            }
                        }), !(e = d.$$childHead || d !== this && d.$$nextSibling))for (; d !== this && !(e = d.$$nextSibling);)d = d.$parent; while (d = e);
                    return f
                }
            };
            var i = new e;
    ...
    function Sc() {
        this.$get = ["$window",
            function (b) {
                var a = {}, c = H((/android (\d+)/.exec(C(b.navigator.userAgent)) || [])[1]);
                return {
    ...
    function Uc() {
        var b = /^\s*(\[|\{[^\{])/, a = /[\}\]]\s*$/, c = /^\)\]\}',?\n/, d = this.defaults = {
            transformResponse: [function (d) {
                ...
                return J(a) && Sa.apply(a) !== "[object File]" ? ba(a) : a
            }], headers: {
                common: {
        ...
        this.$get = ["$httpBackend", "$browser", "$cacheFactory", "$rootScope", "$q", "$injector", function (a, b, c, i, j, k) {
            function l(a) {
                function c(a) {
                    var b = D({}, a, {data: Ob(a.data, a.headers, f)});
                    return 200 <= a.status && a.status < 300 ? b : j.reject(b)
                }

                a.method = la(a.method);
                var e = a.transformRequest || d.transformRequest, f = a.transformResponse || d.transformResponse,
                    g = d.headers, g = D({"X-XSRF-TOKEN": b.cookies()["XSRF-TOKEN"]}, g.common, g[C(a.method)], a.headers), e = Ob(a.data, Nb(g), e), i;
            ...
            function n(b, c, d) {
                ...
                function f(a,
                           c, d) {
                    c = Math.max(c, 0);
                    (200 <= c && c < 300 ? n.resolve : n.reject)({data: a, status: c, headers: Nb(d), config: b})
                }
                ...
                var n = j.defer(), k = n.promise, m, p, w = r(b.url, b.params);
                l.pendingRequests.push(b);
                k.then(h, h);
                b.cache && b.method == "GET" && (m = J(b.cache) ? b.cache : o);
                if (m)if (p = m.get(w))if (p.then)return p.then(h, h), p; else K(p) ? f(p[1], p[0], U(p[2])) : f(p, 200, {}); else m.put(w, k);
            ...
            function r(a,
                ...
                var c = [];
                dc(b, function (a, b) {
                    a == null || a == p || (J(a) && (a = ba(a)), c.push(encodeURIComponent(b) + "=" + encodeURIComponent(a)))
                });
    ...
    function Zc() {
        this.$get = ["$rootScope", "$browser", "$q",
            "$exceptionHandler", function (b, a, c, d) {
                function e(e, f, i) {
                    var j = c.defer(), k = j.promise, l = s(i) && !i, f = a.defer(function () {
                        try {
                            j.resolve(e())
                        } catch (a) {
                            j.reject(a), d(a)
    ...
    function Ub(b, a, c, d, e) {
        ...
        var g = b < 0, b = Math.abs(b), h = b + "", f = "", i = [];
        if (h.indexOf("e") !== -1)f = h; else {
            h = (h.split(Vb)[1] || "").length;
            v(e) && (e = Math.min(Math.max(a.minFrac, h), a.maxFrac));
            var h = Math.pow(10, e), b = Math.round(b * h) / h, b = ("" + b).split(Vb), h = b[0], b = b[1] || "", j = 0, k = a.lgSize, l = a.gSize;
    ...
    function Rb(b) {
        function a(a) {
            ...
            if (b = a.match(c)) {
                ...
                b[9] && (g = H(b[9] + b[10]), h = H(b[9] + b[11]));
                a.setUTCFullYear(H(b[1]), H(b[2]) - 1, H(b[3]));
                a.setUTCHours(H(b[4] || 0) - g, H(b[5] || 0) - h, H(b[6] || 0), H(b[7] || 0))
            }
            return a
        }
    ...
    function Wb(b, a) {
        ...
        var d = this, e = b.parent().controller("form") || Oa, g = 0, h = d.$error = {};
        d.$name = a.name;
        d.$dirty = !1;
        d.$pristine = !0;
        d.$valid = !0;
    ...
    function Qa(b, a, c, d, e, g) {
        ...
        i && (i.match(/^\/(.*)\/$/) ? (i = RegExp(i.substr(1, i.length - 2)), e = function (a) {
            ...
            d.$parsers.push(e));
        if (c.ngMinlength) {
            var k = H(c.ngMinlength), e = function (a) {
        ...
        if (c.ngMaxlength) {
            var l = H(c.ngMaxlength), c = function (a) {
    ...
    }, z = T.Error, Z = H((/msie (\d+)/.exec(C(navigator.userAgent)) || [])[1]), u, ha, ga = [].slice, Ra = [].push, Sa = Object.prototype.toString, Yb = T.angular || (T.angular = {}), sa, Cb, Y = ["0", "0", "0"];
    x.$inject = [];
    ya.$inject = [];
    Cb = Z < 9 ? function (b) {
        b =
    ...
    var jc = /[A-Z]/g, hd = {
    ...
    }, Ba = P.cache = {}, Aa = P.expando = "ng-" + (new Date).getTime(), nc = 1, id = T.document.addEventListener ? function (b, a, c) {
    ...
    }, lc = /([\:\-\_]+(.))/g, mc = /^moz([A-Z])/, ta = P.prototype = {
        ready: function (b) {
            function a() {
                c || (c = !0, b())
            }
        ...
        }, length: 0, push: Ra, sort: [].sort, splice: [].splice
    }, Ea = {};
    ...
    m({
        data: ub, inheritedData: Da, scope: function (b) {
            return Da(b, "$scope")
            ...
            if (s(c))b[a] = c; else return b[a]
        }, text: D(Z < 9 ? function (b, a) {
            if (b.nodeType == 1) {
        ...
        P.prototype[a] = function (a, d) {
            var e, g;
            if ((b.length == 2 && b !== Ca && b !== xb ? a : d) === p)if (J(a)) {
                for (e = 0; e < this.length; e++)if (b === ub)b(this[e], a); else for (g in a)b(this[e], g, a[g]);
                return this
            } else {
    ...
    m({
        ...
        }, unbind: sb, replaceWith: function (a, c) {
    ...
    var qc = /^function\s*[^\(]*\(\s*([^\)]*)\)/m, rc = /,/, sc = /^\s*(_?)(.+?)\1\s*$/, pc = /((\/\/.*$)|(\/\*[\s\S]*?\*\/))/mg, Db = "Non-assignable model expression: ";
    Bb.$inject = ["$provide"];
    var zc = /^(x[\:\-_]|data[\:\-_])/i,
        Fb = /^([^:]+):\/\/(\w+:{0,1}\w*@)?([\w\.-]*)(:([0-9]+))?(\/[^\?#]*)?(\?([^#]*))?(#(.*))?$/, Zb = /^([^\?#]*)?(\?([^#]*))?(#(.*))?$/, Gc = Zb, Gb = {
            http: 80,
            https: 443,
            ftp: 21
        };
    fb.prototype = {
        $$replace: !1, absUrl: Ja("$$absUrl"), url: function (a, c) {
            ...
            this.$$compose();
            return this
        }, hash: Ib("$$hash", ya), replace: function () {
            this.$$replace = !0;
            return this
        }
    };
    ...
    var Ka = {
        ...
        "'": "'",
        '"': '"'
    }, gb = {}, Xc = T.XMLHttpRequest || function () {
            try {
    ...
    var Oa = {$addControl: x, $removeControl: x, $setValidity: x, $setDirty: x};
    ...
    var Ra = {
            name: "form", restrict: "E", controller: Wb, compile: function () {
                return {
                    pre: function (a, c, d, e) {
                        ...
                        var g = c.parent().controller("form"), h = d.name || d.ngForm;
                        h && (a[h] =
                            e);
            ...
            }, hidden: x, button: x, submit: x, reset: x
            ...
            this.$render = x;
            var i = e.inheritedData("$formController") || Oa, j = 0, k = this.$error = {};
            e.addClass(Pa);
            h(!0);
            ...
            return {
                require: "?ngModel", link: function (a, c, d, e) {
                    if (e) {
                        d.required = !0;
                        var g = function (a) {
                            if (d.required && (S(a) || a === !1))e.$setValidity("required", !1); else return e.$setValidity("required", !0), a
                        };
                        e.$formatters.push(g);
                        e.$parsers.unshift(g);
        ...
        }], yd = ib("", !0), zd = ib("Odd", 0), Ad = ib("Even", 1), Bd = R({
    ...
    var Ed = R(function (a, c, d) {
    ...
    }), Hd = R({terminal: !0, priority: 1E3}), Id = ["$locale", "$interpolate", function (a, c) {
        var d = /{}/g;
        return {
            restrict: "EA", link: function (e, g, h) {
                var f = h.count, i = g.attr(h.$attr.when), j = h.offset || 0, k = e.$eval(i), l = {};
                m(k, function (a, e) {
        ...
        transclude: "element", priority: 1E3, terminal: !0, compile: function (a, c, d) {
            return function (a,
                ...
                var l = new db;
                a.$watch(function (a) {
                    var e, f, h = a.$eval(i), m = fc(h, !0), p, u = new db, A, y, v, s, z = c;
                    if (K(h))v = h || []; else {
                        v = [];
                    ...
                    for (f = v.length; e < f; e++) {
                        ...
                        s || d(p, function (a) {
                            z.after(a);
                            s = {scope: p, element: z = a, index: e};
                            u.push(y, s)
                        })
                    }
                    for (A in l)if (l.hasOwnProperty(A))for (v = l[A]; v.length;)y = v.pop(), y.element.remove(), y.scope.$destroy();
                    l = u
                })
            }
        }
            ...
            link: function (e, h, f, i) {
                ...
                function l(e,
                    ...
                    function i() {
                        ...
                        s = g.$modelValue;
                        u = r(e) || [];
                        var y = l ? kb(u) : u, z, w, x;
                        w = {};
                        t = !1;
                        var B, C;
                        if (o)t = new Fa(s); else if (s === null || q)a[""].push({
                            selected: s === null,
                            id: "",
                            label: ""
                        }), t = !0;
                        for (x = 0; z = y.length, x < z; x++) {
                            ...
                            h.push({id: l ? y[x] : x, label: j(e, w) || "", selected: d})
                        }
                        !o && !t && a[""].unshift({id: "?", label: "", selected: !0});
                        w = 0;
                        for (y = c.length; w < y; w++) {
                            ...
                            if (v.length <=
                                ...
                                label: h.label
                            }, u = [s], v.push(u), f.append(s.element); else if (u = v[w], s = u[0], s.label != d)s.element.attr("label", s.label = d);
                            B = null;
                            x = 0;
                            for (z = h.length; x < z; x++)if (d = h[x], t = u[x + 1]) {
                                B = t.element;
                    ...
                    var j = c(h[2] || h[1]), k = h[4] || h[6], l = h[5], m = c(h[3] || ""), n = c(h[2] ? h[1] : k), r = c(h[7]), v = [[{
                        element: f,
                        label: ""
                    }]];
                        ...
                        e.$apply(function () {
                            ...
                            if (o) {
                                ...
                                for (s = v.length; m < s; m++) {
                                    a = v[m];
                                    j = 1;
                                    for (q = a.length; j < q; j++)if ((h = a[j].element)[0].selected)h = h.val(), l && (d[l] = h), d[k] = c[h], i.push(n(e, d))
                                }
        ...
        return {
            restrict: "E", priority: 100, require: "^select", compile: function (d, e) {
                ...
                return function (a, d, e,
                                 j) {
                    j.databound ? d.prop("selected", !1) : j = c;
