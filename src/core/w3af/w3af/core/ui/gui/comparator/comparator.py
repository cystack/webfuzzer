...
class FileDiff(object):
    ...
    def _genLinkMap(self):
        ...
        da.set_property("events",
                        gtk.gdk.BUTTON_PRESS_MASK | gtk.gdk.BUTTON_RELEASE_MASK | gtk.gdk.KEY_PRESS_MASK | gtk.gdk.KEY_RELEASE_MASK)
    ...
    def __init__(self):
        ...
        self.textview_overwrite_handlers = [t.connect("toggle-overwrite", self.on_textview_toggle_overwrite) for t in
                                            self.textview]
        for i in range(2):
