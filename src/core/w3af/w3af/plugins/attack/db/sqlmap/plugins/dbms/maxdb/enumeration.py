...
class Enumeration(GenericEnumeration):
    ...
    def getColumns(self, onlyColNames=False):
        ...
        for tbl in tblList:
            ...
            retVal = pivotDumpTable("(%s) AS %s" % (query, randStr),
                                    ['%s.columnname' % randStr, '%s.datatype' % randStr, '%s.len' % randStr],
                                    blind=True)
            ...
            if retVal:
                ...
                for columnname, datatype, length in zip(retVal[0]["%s.columnname" % randStr],
